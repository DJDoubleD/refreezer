      ...
      body: Container(
          ...
          child: ListView(children: <Widget>[
            ...
            ListTile(
              ...
              leading: const LeadingIcon(Icons.high_quality,
                    ...
                    builder: (context) => SimpleDialog(
                        ...
                        children: List.generate(languages.length, (int i) {
                          ...
                          return ListTile(
                            ...
                            onTap: () async {
                              I18n.of(customNavigatorKey.currentContext!)
                                  .locale = Locale(l.locale, l.country);
            ...
            ListTile(
              ...
              leading:
                  const LeadingIcon(Icons.update, color: Color(0xff2ba766)),
              onTap: () => Navigator.push(
                  context,
                  MaterialPageRoute(
        ...
        body: ListView(
          children: <Widget>[
            ...
            ListTile(
              ...
              leading: const LeadingIcon(Icons.offline_pin,
                ...
                showDialog(
                    ...
                    builder: (context) => CountryPickerDialog(
                          ...
                          onValuePicked: (Country country) {
                            setState(() => settings.deezerCountry =
                                country.isoCode ?? 'us');
                            settings.save();
                          },
                        ));
        ...
        child: ListView(
          children: [
            ...
            ListTile(
              ...
              subtitle:
                  Text('Currently'.i18n + ': ${settings.downloadFilename}'),
                  ...
                  showDialog(
                      ...
                      builder: (context) {
                        return AlertDialog(
                          ...
                          content:
                              Text('Are you sure you want to log out?'.i18n),
                          actions: <Widget>[
                            TextButton(
                              child: Text('Cancel'.i18n),
                              onPressed: () => Navigator.of(context).pop(),
